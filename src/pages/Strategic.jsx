...
const qAnalysis = [
  ...
  },
  {
    ...
    edges:[
      ...
      {title:"The vision requires capabilities that don't exist yet", body:"Wearable HRV integration, real-time NS state tracking, and parts-informed AI coaching require hardware and model capabilities that may not be reliable within 3 years. Visioning around them creates fragile plans."},
  ...
  },
  {
    ...
    edges:[
      {title:"The knowledge holder IS the competitive moat", body:"Your clinical relationship management style, referral physician rapport, and nervous system lens interpretation are not just knowledge — they ARE the product. Externalizing them dilutes differentiation if not handled with extreme care."},
  ...
  },
  {
    ...
    edges:[
      {title:"The off-the-shelf product is 80% right but the 20% gap is your differentiation", body:"A commercial exercise prescription platform covers 80% of Clinical Brain's function. The 20% it doesn't cover — nervous system state classification, parts-based language overlays, Core Three fascial integration — is your actual IP. You can't buy the 20%."},
      ...
      {title:"Your clinical IP requires custom data modeling no off-the-shelf product supports", body:"Myers fascial lines × Comerford motor control × Shacklock neurodynamics × nervous system state is a schema that doesn't exist in any commercial product. You can buy the container but the schema must be built."},
    ]
  },
  {
  ...
  },
  {
    ...
    edges:[
      ...
      {title:"You test an assumption and it's wrong but the business is already built around it", body:"Movement Solutions is built around the belief that the Chicago North Shore market values a nervous-system-informed clinical approach. If the empirical test shows clients primarily chose you for convenience and insurance coverage, the brand repositioning cost is enormous."},
  ...
  },
  {
    ...
    edges:[
      ...
      {title:"Clinical Brain breaks because the core prompt logic was never documented", body:"The Mechanic's most important logic — the edge-case handling, the contraindication reasoning, the parts-based framing — lives in your understanding of what the prompt should do, not in the prompt itself. Day 7: an edge case appears. No one knows how to handle it."},
...
const moreHabits = [
  ...
  { id:"42", category:"Clinical Systems", title:"Add a Real-Time NS State Filter to the Exercise Delivery UI for Clinicians", body:"Clinicians prescribing from the 189-exercise library should be able to filter by NS state (Green/Amber/Red) in real time during a session. This makes the NS state classification layer clinically actionable rather than just theoretically tagged." },
  ...
  { id:"45", category:"Knowledge Systems", title:"Build a Somatic Signal Dictionary — Shared Vocabulary Mapping Clinical Observations to Parts-Based Language", body:"The Mechanic, The Sniper, and The Overseer need a shared vocabulary for somatic states. A curated dictionary mapping clinical observations (e.g., guarded movement, breath-holding, hypervigilance posture) to parts-based language creates consistent agent prompting across the entire Clinical Brain system." },
  ...
  { id:"49", category:"Referral Systems", title:"Conduct a Dark Patterns Audit on Kylie's Intake Flow Against Nervous System Principles", body:"Kylie's efficiency optimization and your clinical values can diverge subtly. An audit specifically asking 'does this intake moment create dorsal shutdown or sympathetic activation in a dysregulated client?' ensures your AI receptionist aligns with the NS-informed approach that defines your brand."},
...
const newQuestions = [
  ...
  },
  {
    ...
    edges:[
      {title:"Defensibility of Core Three as IP", body:"You'd have to believe that no well-funded competitor can replicate the Myers-Comerford-Shacklock-NS-parts awareness integration in 18 months — which requires believing your clinical synthesis is genuinely novel, not just a framework mashup."},
      ...
      {title:"parts awareness overlay is clinically defensible at consumer scale", body:"parts-based language in a clinical context is appropriate when supervised. A consumer app using parts-based framing without a clinician in the loop enters a different clinical and liability territory. You'd have to believe the app's design handles this safely."},
  ...
  },
  {
    ...
    edges:[
      ...
      {title:"A well-funded health tech company could train on PT literature and get close", body:"The gap between a generic exercise prescription AI and Clinical Brain is significant today and shrinking rapidly. 18 months is enough time for a funded competitor to get to 80% of your methodology. The question is whether the remaining 20% — the parts awareness overlay, the NS state classification, the relationship layer — is actually moat or just differentiation."},
      {title:"The NS framework's clinical applications are being contested in the literature", body:"The founding research is influential and also under increasing academic scrutiny in clinical applications. If the evidentiary base for nervous-system-informed PT is challenged in the literature, competitors can use that controversy to commoditize your approach or, worse, to discredit it."},
      {title:"parts-based language is the most distinctive element and the least empirically validated", body:"The parts awareness overlay is the element that most differentiates your approach from any competitor. It's also the element with the thinnest empirical evidence base in PT specifically. Distinctiveness without validation is a vulnerability in a regulated clinical environment."},
  ...
  },
  {
    ...
    edges:[
      ...
      {title:"You'd build the somatic app now and accept the trade-off with other builds", body:"Consumer market timing is compressed. The first credible somatic integration app with a NS-parts-fascial framework that achieves meaningful retention locks the category. Being second in a consumer health category is being invisible."},
  ...
  },
  {
    ...
    edges:[
      ...
      {title:"Clinical Brain's multi-agent architecture exists primarily in working memory", body:"The full Clinical Brain system — four agents, their payloads, handoff contracts, parts awareness integration layer — is documented in the architecture doc but likely held primarily in your working memory during sessions. This is the most cognitively expensive single asset in your system."},
