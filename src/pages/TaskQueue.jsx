...
const TRIGGER_CONFIG = {
  ...
  '033': { trigger: 'manual', freq: 'once', prompt: 'Integrate IFS part detection and Panksepp affective systems into session arc routing. Requires deep clinical psychology framework knowledge.' },
...
const CASES = [
  ...
  { id:"033", title:"IFS + Panksepp Integration into Prescription", domain:"BRAIN", priority:"P1", agent:"The Mechanic", oracle:"Private", status:"TODO", depends:["015","016"], desc:"Layer IFS part detection and Panksepp affective systems into session arc routing logic." },
